    ...
    <div class="sidebar">
		...
		<div class="main-content">
			...
			<div class="content-section">
				<h3 class="section-title">스터디 그룹 수정</h3>
				<br>
				<div class="form-group">
					<label class="form-label">그룹 번호</label> 
					<input type="text" class="form-input" name="groupNumber" id="groupNumber"
						value="<%=group.groupNumber() %>" disabled/>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="form-label">그룹 상태</label> <select name="status"
						class="form-input">
				...
				<div style="text-align: right;">
					<button id="updateBtn" class="btn btn-primary">
						<i class="bi bi-file-person"></i>그룹 수정하기
					</button>
				</div>
			</div>
		</div>
...
document.addEventListener('DOMContentLoaded', () => {
	...
	fetch("<%=request.getContextPath()%>/study/updategroup.do",{
		method: 'POST',
      headers: {
