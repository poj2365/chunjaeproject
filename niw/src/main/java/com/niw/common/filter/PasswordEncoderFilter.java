...
import com.niw.common.PasswordEncoder;

/**
 * Servlet Filter implementation class PasswordEncoderFilter
 */
@WebFilter(servletNames = {"memberEnrollEndServlet","loginServlet","findServlet","changePassword"})
